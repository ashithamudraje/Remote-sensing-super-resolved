...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=  # noqa: E251
        '/netscratch/mudraje/super_resolution_remote_sensing/BasicSR/ESRGAN_PSNR_SRx4_DF2K_official-150ff491.pth'  # noqa: E501
    )
    parser.add_argument('--input', type=str, default='/netscratch/mudraje/super_resolution_remote_sensing/images', help='input test image folder')

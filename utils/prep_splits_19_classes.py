...
# This script creates splits with TFRecord files from 1) BigEarthNet v1.0
...
with open('/netscratch/mudraje/super_resolution_remote_sensing/BigEarthNet-S2_19-classes_models/label_indices.json', 'rb') as f:
    label_indices = json.load(f)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=
        'This script creates TFRecord files for the BigEarthNet v1.0 train, validation and test splits')
    ...
    parser.add_argument('-label', '--label_folder', dest = 'label_folder',
                        help = 'label folder path contains multiple patch folders')
